...
namespace AwsConsoleApp1
{
    class Program
    {
        ...
        {
            //Amazon.Util.ProfileManager.RegisterProfile("Chrisjw42", "AKIAJ65JLQAK4WBGS5NA", "EJDFXPwUb2HS90r0KGSA9UJDNFbRd7X9/Z0oWlXo");
        ...
        // Default example project methods, being ignored, just there for reference
        public static string GetServiceOutput()
        {
            ...
            using (StringWriter sr = new StringWriter(sb))
            {
                ...
                sr.WriteLine("===========================================");
                sr.WriteLine("You are a clunge and you know it");
